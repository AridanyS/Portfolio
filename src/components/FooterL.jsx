  ...
  */
  ...
  export default function FooterPortfolio() {
    return (
      <div className="flex h-[8vh] justify-evenly flex-wrap md:gap-3 items-center p-3 max-sm:text-[10px] lg:text-lg text-text-modal-light bg-background-DarkBrown">
        ...
        <div className="flex items-center md:gap-3 ">
          ...
          <a href="https://mit-license.org/" className=" hover:underline" target="_blank">MIT license </a><img src="/scale.svg" className="w-[13px] lg:w-[25px] bg-text-modal-light opacity-80 rounded m-1 " alt="MIT"></img>
        </div>
